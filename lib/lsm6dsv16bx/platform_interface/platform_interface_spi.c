...
LOG_MODULE_REGISTER(platform_interface, CONFIG_LSM6DSV16BX_LOG_LEVEL);
// Configuration structures
static const struct spi_dt_spec imu_spi = SPI_DT_SPEC_GET(DT_NODELABEL(lsm6dsv16bx), LSM6DSV16BX_SPI_OP, 10);

...
Then, put the device on OTA DFU mode by sending the `dfu ota` command via the shell.
...
- INIT: use the zephyr.dat file inside the zip file generated by adafruit-nrfutil
